...
function Footer() {
  return (
    <div className="Container w-[100%] mx-auto max-w-[1920px] " >
    <div className="w-full 2xl:h-[416px] top-[3626px] py-[80px] px-[30px] md:py-[130px] md:px-[80px] lg:py-[110px] lg:px-[120px] 2xl:py-[140px] 2xl:px-[220px] bg-[#043873]  " >
        <div className="flex flex-wrap gap-10 md:gap-[50px] font-inter text-white " >
            <div className="w-[295px] lg:w-[250px] h-[169px] flex flex-col gap-3 md:gap-[15px] " >
            ...
            <div className="flex flex-col gap-2 md:gap-[15px] w-[295px] lg:w-[250px] " >
